...
import 'allhulkahfi.dart';

class Hayyulhadi extends StatefulWidget {
  @override
  _HayyulhadiState createState() => _HayyulhadiState();
}

class _HayyulhadiState extends State<Hayyulhadi> {
      ...
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Allahulkahfi()),
            );
          },
        ),
        title: Column(
